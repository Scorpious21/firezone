...
import { keys, G, obstacles, playerPos, playerLook, refs } from './state.js';
...
export const getYaw   = () => playerLook.yaw;
export const getPitch = () => playerLook.pitch;
...
export function movePlayer(dt, touchMove){
  ...
  // publish to shared state for other modules
...
export function isMoving(){
  return (keys.w||keys.a||keys.s||keys.d) && PLAYER.grounded;
}